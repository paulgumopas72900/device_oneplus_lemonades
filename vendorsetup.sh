...
git clone --depth=1 https://github.com/manidweep/device_oneplus_sm8250-common.git -b elixir device/oneplus/sm8250-common
...
# Common Vendor Tree
git clone --depth=1 https://github.com/manidweep/vendor_oneplus_sm8250-common.git -b elixir vendor/oneplus/sm8250-common
...
git clone --depth=1 https://github.com/manidweep/hardware-oplus.git -b elixir hardware/oplus

echo 'Cloning Op Extras [6/7]'
# Packages Op Extras
rm -rf packages/apps/OPlusExtras
git clone --depth=1 https://github.com/manidweep/packages_apps_OPlusExtras.git -b elixir packages/apps/OPlusExtras
